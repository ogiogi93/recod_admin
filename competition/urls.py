...
urlpatterns = [
    ...
    url(r'^team/(?P<team_id>\d+)/participate/$', participate_competition, name='participate_competition'),
    ...
    url(r'^participate/(?P<competition_id>\d+)/(?P<team_id>\d+)/$', refusal_competition, name='refusal_competition'),
